...
// on definie une liste chainee que l'on utilise pour classer les elements de PileN
...
pPileN Pile_de_noeuds;

liste ltrie;


//fonctions deja developpees
pPileN creerPileN(); //creer une pile vide et retourner son adresse
...
pNoeud chercherSalaire(pNoeud arbre, int salaire); // ajouté
...
liste ajoutListeTri(liste l , pNoeud najout);//fonction utilisé pour afficherEmployés. celle ci a été ajouté
